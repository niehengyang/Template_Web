        ...
        methods: {
            ...
            create() {
                ...
                this.$refs["createForm"].validate(valid => {
                    ...
                    this.$api.restfulApi.create("devicefile", this.createForm).then(() => {
            ...
            getAllot(){
                ...
                this.$api.restfulApi.list('devicefile/filepermission', params).then(res => {
                    console.log(res)
                    ...
                    res.airConUser.forEach(item => {
                        this.options[2].children.push({value: item.id, label: item.loginname})
                    })
                })
            },
            //文件上传成功
