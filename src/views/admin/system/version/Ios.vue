                ...
                <el-col :span="24">
                    <div class="search-row">
                        <div class="search-btn-group">
                            <el-button type="primary" size="medium" @click="dialogAddVisible = true">{{$t('lang.version-upload')}}</el-button>
                        </div>
                    </div>
                </el-col>
            </el-row>
...
<!--                        <el-table-column label="更新地址" prop="version_site"></el-table-column>-->
                    </el-table>
                </el-col>
            </el-row>
            ...
            <el-dialog class="dialog-form" :title="$t('lang.version-upload')" :visible.sync="dialogAddVisible">
                <ios-create @closeCreate="dialogClose" @create="createHandle"></ios-create>
            </el-dialog>
...
<script>
    import IosCreate from './IosCreate'
    export default {
        data() {
            return {
                tableData: [],
        ...
        methods: {
            initData(id){
                ...
                this.$api.restfulApi.list("ios", params).then(response =>{
